...
FOREIGN KEY (Bidder_Id) REFERENCES User(Email_Id) ON DELETE CASCADE,
FOREIGN KEY (AdvertisementId) REFERENCES SaleAdvertisement(AdvertisementId) ON DELETE CASCADE
);